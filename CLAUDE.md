...
├── components/           共享组件（HistoryTag/MissedMark/SummarySheet等只读/预览/总结相关；GoalRow/GoalEditorSheet/WeeklyCompareTable/ShareCard等PDCA周报相关；MonthGrid/DateJumpSheet日历选择器；MessageBoard/MessageComposerDialog留言板）
├── lib/
